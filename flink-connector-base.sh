...
mvn org.apache.maven.plugins:maven-install-plugin:2.5::install-file -DgroupId=org.apache.flink -DartifactId=flink-file-sink-common -Dversion=1.18-SNAPSHOT -Dfile=/Users/xingcan/IdeaProjects/flink/flink-connectors/flink-file-sink-common/target/flink-file-sink-common-1.18-SNAPSHOT.jar -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true -DpomFile=/Users/xingcan/IdeaProjects/flink/flink-connectors/flink-file-sink-common/pom.xml
